...
#define DEFAULT_WIFI_SSID           "Xiaomi 14"   ///< 默认连接的WiFi网络名称
#define DEFAULT_WIFI_PASSWORD       "67489000"   ///< 默认WiFi网络密码
// #define DEFAULT_WIFI_SSID           "TP-LINK_A440"   ///< 默认连接的WiFi网络名称
// #define DEFAULT_WIFI_PASSWORD       "15392281065ABC"   ///< 默认WiFi网络密码
